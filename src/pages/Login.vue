<template>
    <div>
        ...
        <div v-show="chosedFunction">
            <el-form v-show="isLogin" :model="ruleForm" :rules="rules" ref="loginFormEl" label-position="left" label-width="0px" class="login-container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clearForm() {
                this.$refs['loginFormEl'].resetFields()
            },
            ...
            getVerificationCode() {
                ...
                if (!reg.exec(this.regRuleForm.tel)) {
                    ...
                    axios.post(`${baseUrl}/Account/SMS`, smsParams)
                        .then(res => {
                            if (res.data.Code === 0) {
                                let sec = 30;
                                for (let i = 0; i <= 30; i++) {
