...
//                    var printSth = document.getElementsByClassName("paperform-form")[0].innerHTML
                    var roundImg = document.getElementsByClassName("paperform-form")[0].innerHTML;
                    ...
                    // LODOP.NewPage();
                    LODOP.ADD_PRINT_HTM('10', '120', '95%', '25.7cm', roundImg);
                }
                else if (this.paperIndex === 6) {
                    styleCSS = "<link href='../../static/printCPEPscore.css' type='text/css' rel='stylesheet'>"
                    var printSth = document.getElementsByClassName("paperform-form")[0].innerHTML
