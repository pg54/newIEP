<template>
    <div class="mainIEP">
        ...
        <el-dialog title="选择患者" :visible="choseToTestVisible" :modal-append-to-body="false" :close-on-click-modal="false" @close="resetChosePatientTest"
            :show-close="false">
    ...
    export default {
        ...
        methods: {
            ...
            choseToTestSubmit(title, isComplete) {
                ...
                api.chosePatientToTest(params).then(res => {
                    if (res.Code === 0) {
                        ...
                        this.$router.push({
                            path: '/iep/testManage/resultPaper'
                        });
            ...
            checkPacientTestReport(index, row) {
                ...
                this.$store.dispatch('setTESTID', row.ID);
                this.$router.push({
                    path: '/iep/testManage/reportPaper'
                });
