<template>
    <el-dialog title="新增计划" :visible="planFormVisibilty" :close-on-click-modal="false" :show-close="false" size="large">
            ...
            <el-form-item label="课程">
                <div class="checkBoxWrap">
                    <el-checkbox-group v-model="checkBoxValues">
                        <el-checkbox v-for="(item, index) in courseData" :key="index" :label="item.ID" class="courseCheckBox">{{ item.Name }}</el-checkbox>
                    </el-checkbox-group>
                </div>
