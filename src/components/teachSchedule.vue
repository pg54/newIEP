<template>
    <div class="tabs">
                                ...
                                <div class="toolBox">
                                    <el-row v-if="isIEP" type="flex" justify="space-between">
                                        <el-col :span="10">
                                            <el-row :gutter="35">
                                                <el-col :span="16">
                                                    <input class="onc-input" v-model="filttGroup" placeholder="输入分组名称、计划名称查询" @keyup.13="getGroupName"></input>
                                                </el-col>
                                                <el-col :span="8">
                                ...
                                <div class="toolBox">
                                    <el-row v-if="isIEP" type="flex" justify="space-between">
                                        <el-col :span="10">
                                            <el-row :gutter="10">
                                                <el-col :span="16">
                                                    <input class="onc-input" v-model="filttUser" placeholder="输入患者名称、计划名称查询" @keyup.13="getUserName"></input>
                                                </el-col>
                                                <el-col :span="8">
        ...
        <!--新增计划Dialog-->
        <el-dialog :title="isModifyPlan? '修改计划':'新增计划'" v-model="addPlanDialogFlag" :modal-append-to-body="false" :show-close="false" :close-on-click-modal='false'
            ...
            <el-form ref="form" :model="planFormData" label-width="100px">
                ...
                <template v-else>
                    ...
                    <el-row :gutter="24">
                        ...
                        <!-- <el-col :span="12">
                            <el-form-item label="">
                                <el-button @click.native="addCoursePackage = !addCoursePackage">添加课程包</el-button>
                            </el-form-item>
                        </el-col> -->
                    </el-row>
